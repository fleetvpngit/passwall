...
rm -f passwall.sh && wget https://raw.githubusercontent.com/fleetvpngit/passwall/main/passwall.sh && chmod 777 passwall.sh && sh passwall.sh
...
rm -f passwall2x.sh && wget https://raw.githubusercontent.com/fleetvpngit/passwall/main/passwall2x.sh && chmod 777 passwall2x.sh && sh passwall2x.sh
